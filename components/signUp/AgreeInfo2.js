        ...
        <ScrollView>
          ...
          <View style={{ marginTop: 14 }}>
            <Text style={styles.content}>
              ...
              3년까지 보관되며, 보존기간이 만료되었을 경우 즉시 파기를
              진행합니다. 또한, 사용자가 ‘어플리케이션 운영주체' 에게 본인의
              개인정보 삭제 요청 시 지체 없이 삭제를 진행하고 그에 대한 결과를
              통보해 드립니다.
            </Text>
          </View>
          ...
          <View style={{ marginTop: 14 }}>
            <Text style={styles.content}>
              {""}
              {"\u0020 "}• {"\u0020 "}전자적 파일형태(DB, PC)로 저장된
              개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 파기
              합니다. 종이로 출력된 개인정보는 분쇄기로 분쇄하여 파기합니다.
            </Text>
          </View>
          ...
          <View style={{ marginTop: 14, marginBottom: 44 }}>
            <Text style={styles.content}>
              {""}
              {"\u0020 "}• {"\u0020 "}사용자는 아래 개인정보의 수집 및 이용에
              관해 동의 하지 않을 권리가 있습니다. 다만, ‘1:1문의'를 통해
              제공받는 정보는 문의를 처리하기에 필수적인 항목으로 해당 정보를
              제공받지 못할 경우 ‘1:1문의'를 이용하실 수 없습니다.
            </Text>
          </View>
        </ScrollView>
      </View>
