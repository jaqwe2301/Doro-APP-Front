  ...
  return (
    <View style={{ backgroundColor: "white", flex: 1 }}>
      <ScrollView>
        ...
        <View
          style={{ marginTop: 14, marginHorizontal: 20, flexDirection: "row" }}
        >
        ...
        <View style={{ marginTop: 14, marginHorizontal: 20 }}>
          <Text style={styles.content}>
            ...
            서비스의 개별 약관, 운영정책 및 규칙(이하 '세부 지침'이라 합니다)의
        ...
        >
          ...
          <Text style={[styles.content, { marginRight: 20 }]}>
            가입신청자가 본 약관에 따라 회원자격을 상실한 적이 있는 경우. 다만,
            '회사'의 재가입 승낙을 얻 은 경우에는 예외로 합니다.
          </Text>
        </View>
        <View
          style={{
        ...
        >
          ...
          <Text style={[styles.content, { marginRight: 20 }]}>
            기타 강의신청을 승낙하는 것이 '회사'의 기술상 현저한 지장을 초래하는
            것으로 인정되는 경우
          </Text>
        </View>
        <View
        ...
        >
          ...
          <Text style={[styles.content, { marginRight: 20 }]}>
            ...
            권리를 주장할 수 없으며, '회사'는 이로 인하여 발생한 손해 에 대하여
            책임을 부담하지 않습니다.
          </Text>
        </View>
        ...
        <View style={{ marginHorizontal: 20, flexDirection: "row" }}>
          ...
          <Text style={[styles.content, { marginRight: 20 }]}>
            ...
            관할하는 법원을 제1심 관할법원 으로 하며, 준거법은 대한민국의 법령을
            적용 합니다.
          </Text>
        </View>
